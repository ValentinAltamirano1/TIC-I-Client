...
public class LogInController implements Initializable {
    ...
    void LogInClickedButton(ActionEvent event) throws IOException {
        ...
        if (txt_email.getText().equals("hola") && txt_contraseña.getText().equals("hola")) {
            Parent root = FXMLLoader.load(getClass().getResource("/com/example/usuario/usuario/Actividades/VerActividadesPRUEBA.fxml"));
            stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
